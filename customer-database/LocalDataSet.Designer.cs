...
namespace customer_database.LocalDataSetTableAdapters {
    ...
    public partial class CustomerTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Customer] ([Name], [Email]) VALUES (@Name, @Email);\r\nSELECT Id" +
                ", Name, Email FROM Customer WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Customer] SET [Name] = @Name, [Email] = @Email WHERE (([Id] = @Orig" +
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::customer_database.Properties.Settings.Default.LocalConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Email FROM dbo.Customer";
        ...
        public virtual int Fill(LocalDataSet.CustomerDataTable dataTable) {
        ...
        public virtual LocalDataSet.CustomerDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            LocalDataSet.CustomerDataTable dataTable = new LocalDataSet.CustomerDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(LocalDataSet.CustomerDataTable dataTable) {
